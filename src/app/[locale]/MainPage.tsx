      ...
      <section className={classNames(styles.container, styles.projects)}>
        <div className={styles.projects__header}>
          <h2 className={styles.projects__header__title}>
            {t('header.1')}{' '}
            <span className={styles.projects__header__title_orange}>{t('header.2')}</span>
            {', '}
            <span className={styles.projects__header__title_orange}>{t('header.3')}</span>
            {` ${t('header.4')} `}
            <span className={styles.projects__header__title_orange}>{t('header.5')}</span>
          </h2>
